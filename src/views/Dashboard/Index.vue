          ...
          <div class="page-header d-print-none">
            <div class="row g-2 align-items-center">
              ...
              <div class="col-12 col-md-auto ms-auto d-print-none">
                <div class="btn-list">
                  <router-link to="/create/service" class="btn btn-primary d-none d-sm-inline-block">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="subheader">Prestataires</div>
                    </div>
                    <div class="h1 mb-2">75</div>
                    <div class="progress progress-sm mt-6">
                      <div class="progress-bar bg-blue" style="width: 100%" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" aria-label="75% Complete">
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Mes prestations({{  services?.length }})</h3>
                  </div>
                    ...
                    <table class="table card-table table-vcenter text-nowrap datatable">
                      ...
                      <tbody>
                        <tr v-for='service in services' v-bind:key="service.id">
                          <td><span class="text-muted">{{ service.created_at }}</span></td>
